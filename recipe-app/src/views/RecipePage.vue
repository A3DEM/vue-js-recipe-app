    ...
    <div class="recipe">
        <div class="content">
            <div class="recipe-imgbox">
                <img class="recipe-img" src="@/assets/img/bg.jpg" alt="Salade César">
            </div>
            <div class="recipe-content">
                <h1 class="recipe-content-title">Salade César</h1>
                ...
                <div class="recipe-content-img">
                    <img src="@/assets/img/bg.jpg" alt="Salade César">
                </div>
                    ...
                    <div class="recipe-content-steps-list">
                        <div class="recipe-content-step">
                            ...
                            <p class="recipe-info-paragraph">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam nec aliquam massa. Mauris egestas pretium dapibus. Morbi erat velit, auctor at metus sit amet, aliquam ullamcorper dui. Proin at metus elementum, lobortis nunc nec, commodo leo.
                            </p>
                        </div>
                        <div class="recipe-content-step">
                            <span class="recipe-step">2</span>
                            <h3 class="recipe-info-title">
                                Cuisson
                            </h3>
                            <p class="recipe-info-paragraph">
                ...
                <div class="recipe-content-rating">
                    <h2>Avis</h2>
                    <p>Praesent lobortis, est ac sodales fermentum ?</p>
                    <div class="recipe-content-stars">
